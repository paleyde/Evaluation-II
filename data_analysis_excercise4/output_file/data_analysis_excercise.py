...
data4_unique_source=data4_unique_source.rename(columns={'coin':'No._of_entries_of_coin'})
...
data4_unique_date=data4_unique_date.rename(columns={'new_date':'No._of_entries_on_each_date'})
